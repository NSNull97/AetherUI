...
// MARK: - TouchEffect
// Direct port of Telegram-iOS `TouchEffect` from
// submodules/TelegramUI/Components/GlassBackgroundComponent/Sources/TouchEffect.swift.
...
// Direct port of Telegram's `GlassHighlightGestureRecognizer`.
