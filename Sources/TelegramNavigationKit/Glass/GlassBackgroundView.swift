...
/// Port of Telegram-iOS `GlassBackgroundComponent.GlassBackgroundView` targeting
...
public class GlassBackgroundView: UIView {
    ...
    /// Matches Telegram's `useCustomGlassImpl` debug switch.
    ...
    // MARK: Static image generators (port of Telegram helpers)
...
// MARK: - GlassBackgroundContainerView (port of Telegram's UIGlassContainerEffect host)
