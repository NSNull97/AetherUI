...
/// Port of Telegram-iOS `GlassControlGroupComponent`, adapted from ComponentFlow to plain UIKit.
public final class GlassControlGroup: UIView {
    ...
    public func update(
        ...
        // visible empty pill next to real content (matches Telegram's behaviour).
        if items.isEmpty {
...
final class HighlightTrackingButton: UIButton {
    ...
    /// Port of Telegram's glass-press animation: spring-scale up to 1.1 on
...
/// Port of Telegram-iOS `GlassControlPanelComponent`.
