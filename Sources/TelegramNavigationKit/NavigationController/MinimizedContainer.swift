...
/// Replaces Telegram's ASDK-based MinimizedContainer protocol.
public protocol MinimizedContainerProtocol: UIView {
    var navigationController: TelegramNavigationController? { get set }
    ...
    func addController(_ viewController: MinimizableController, topEdgeOffset: CGFloat?, beforeMaximize: @escaping (TelegramNavigationController, @escaping () -> Void) -> Void, transition: ContainedViewLayoutTransition)
