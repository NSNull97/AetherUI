...
/// Modal sheet container — direct port of Telegram-iOS
...
///
/// The "sheet" gesture-coordination trick is the key Telegram move: an outer
...
public final class NavigationModalContainer: UIView, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    init(
        ...
        // Match Telegram exactly — compact width-class modals dim the backing
        ...
        // Container clip + smooth corners (Telegram applies `applySmoothRoundedCorners`
        // — we use `.continuous` corner curve which is the public equivalent).
        containerView.clipsToBounds = true
        containerView.layer.cornerCurve = .continuous

        // Scroll view tuned exactly like Telegram's: vertical-only, no bounce,
    ...
    func containerLayoutUpdated(_ layout: ContainerViewLayout, transition: ContainedViewLayoutTransition) {
        ...
        // Match Telegram: scroll occupies the full screen, contentSize is
    ...
    func animateIn(completion: (() -> Void)? = nil) {
        // Direct port of Telegram's `animateIn`:
        //
        ...
        // inside the 2× scroll content). Telegram's offset formula:
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        // Telegram formula. 0 = fully presented, 1 = dismissed.
    ...
    public func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        // Snap to either dismissed or restored — same as Telegram.
