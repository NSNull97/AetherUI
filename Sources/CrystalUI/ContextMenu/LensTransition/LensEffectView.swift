...
/// CrystalUI port of Telegram's `LensTransitionContainerEffectViewImpl`
...
public final class LensEffectView: UIView, LensTransitionContainerEffectView {
    ...
    public func updateAppearance(isDark: Bool) {
        ...
        if #available(iOS 26.0, *) {
            // Telegram applies the same `.regular` style for both themes; the
            // dark/light differentiation is driven by `lumaMin/lumaMax` inside
            // `EffectSettingsContainerView`, not by the glass effect itself.
