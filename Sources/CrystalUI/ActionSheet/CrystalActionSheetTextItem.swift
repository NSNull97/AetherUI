...
public final class CrystalActionSheetTextItem: CrystalActionSheetItem {
    public enum Font {
        case `default`
        case large
    }
    ...
    public func makeView(theme: CrystalActionSheetTheme) -> CrystalActionSheetItemView {
        let view = CrystalActionSheetTextItemView(theme: theme)
        view.setItem(self)
        return view
    }

    public func updateView(_ view: CrystalActionSheetItemView) {
        guard let view = view as? CrystalActionSheetTextItemView else { return }
        view.setItem(self)
    }
}

final class CrystalActionSheetTextItemView: CrystalActionSheetItemView {
    ...
    func setItem(_ item: CrystalActionSheetTextItem) {
