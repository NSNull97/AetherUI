...
public protocol MinimizedContainerProtocol: UIView {
    var navigationController: CrystalNavigationController? { get set }
    ...
    func addController(_ viewController: MinimizableController, topEdgeOffset: CGFloat?, beforeMaximize: @escaping (CrystalNavigationController, @escaping () -> Void) -> Void, transition: ContainedViewLayoutTransition)
